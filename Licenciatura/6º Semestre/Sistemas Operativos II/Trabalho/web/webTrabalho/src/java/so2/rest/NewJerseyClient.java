...
public class NewJerseyClient {
    ...
    public NewJerseyClient() {
        ...
        webTarget = client.target(BASE_URI).path("quest");
    }

    /**
     * @param requestEntity request data@return response object (instance of responseType class)
     */
    public void updateAnswer(Object requestEntity) throws ClientErrorException {
     ...
     * @param requestEntity request data@return response object (instance of responseType class)
     */
    public void addQuest(Object requestEntity) throws ClientErrorException {
     ...
     */
    public void removeQuest(String index) throws ClientErrorException {
